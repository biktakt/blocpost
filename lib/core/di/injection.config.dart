...
import 'package:blocpost/features/comment/data/datasources/comment_remote_data_source.dart'
    as _i933;
import 'package:blocpost/features/comment/data/repositories/comment_repository_impl.dart'
    as _i127;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i933.CommentRemoteDataSource>(
      () => _i933.CommentRemoteDataSourceImpl(dio: gh<_i361.Dio>()),
    );
    gh.lazySingleton<_i251.PostRemoteDataSource>(
      () => _i251.PostRemoteDataSourceImpl(dio: gh<_i361.Dio>()),
    );
    gh.lazySingleton<_i43.CommentRepository>(
      () => _i127.CommentRepositoryImpl(
        postRemoteDataSource: gh<_i933.CommentRemoteDataSource>(),
      ),
    );
    ...
    gh.factory<_i162.GetComments>(
      () => _i162.GetComments(gh<_i43.CommentRepository>()),
    );
    return this;
  }
}
